...
export const DownloadIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v10m0 0l4-4m-4 4l-4-4M4 17v2a2 2 0 002 2h12a2 2 0 002-2v-2" />
  </svg>
);
...
export const CpuChipIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h1a2 2 0 002-2v-1a2 2 0 012-2h1.945M3.055 11A9.954 9.954 0 012 13.999a9.992 9.992 0 002.28 5.45M3.055 11A9.954 9.954 0 002 8.001a9.992 9.992 0 012.28-5.45m15.89 0A9.992 9.992 0 0122 8.001a9.992 9.992 0 00-2.28 5.45m15.89 0A9.992 9.992 0 0022 13.999a9.992 9.992 0 01-2.28-5.45M5 21V19a2 2 0 012-2h10a2 2 0 012 2v2M5 3V5a2 2 0 002 2h10a2 2 0 002-2V3" />
    </svg>
);
